...
const navLinks: NavListItem[] = [
  { name: 'How to Green Your Lab', href: '#' },
  { name: 'Programs', href: '#' },
  { name: 'Resources', href: '#' },
  { name: 'About Us', href: '#' },
...
const levelData: Level[] = [
  { name: 'Bronze', score: 40, color: '#964B00' }, // Brown for Bronze
  { name: 'Silver', score: 50, color: '#C0C0C0' }, // Silver
  { name: 'Gold', score: 60, color: '#FFD700' },   // Gold
  { name: 'Platinum', score: 70, color: '#E5E4E2' }, // Platinum (Light Grey)
  { name: 'Green', score: 80, color: '#4CAF50' },   // Green
];
        ...
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h1 className="text-5xl lg:text-6xl font-extrabold text-gray-800 leading-tight mb-6">
              My Green Lab<sup className="text-xl">&reg;</sup> Certification
            </h1>
    ...
    <div className="container mx-auto max-w-7xl px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {resultsData.map((item, index) => (
          ...
          >
            <p className="text-6xl font-extrabold text-green-800 mb-4">{item.value}</p>
        ...
        {iconCards.map((card, index) => (
          <div key={index} className="flex flex-col items-center text-center px-2">
            ...
            <p className="text-xs font-semibold uppercase text-gray-700 tracking-wider">
              {card.label.replace(' ', '\u00a0')} {/* Non-breaking space for better wrapping */}
            </p>
          </div>
        ))}
      </div>
            ...
            {certificationSteps.map((step, index) => {
              ...
              return (
                <div key={step.id} className="relative flex flex-col items-center lg:w-1/4">
                  ...
                  <div className="absolute top-16 left-1/2 transform -translate-x-1/2 w-0.5 h-8 border-l-2 border-dashed border-gray-400 hidden lg:block"></div>
...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* The video section would require embedding and custom styling, but the surrounding content is more critical for the page structure. */}
      <section className="py-20 text-center bg-gray-50">
        ...
        {/* Placeholder for the video player visible in the original page */}
        <div 
