  ...
  return (
    <div className="bg-white">
      ...
      <footer className="bg-gray-800 text-white pt-16 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 border-b border-gray-700 pb-10 mb-8">
            {/* Logo/Branding */}
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="/accredited-professionals" className="hover:text-white transition">Accredited Professionals</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><a href="/follow" className="hover:text-white transition">Follow Us</a></li>
            ...
            {/* Learn More */}
            <div>
              <h4 className="text-lg font-semibold mb-4 text-green-500">Learn More</h4>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="/events" className="hover:text-white transition">Events</a></li>
                <li><a href="#" className="hover:text-white transition">Careers</a></li>
                <li><a href="/strategic-plan" className="hover:text-white transition">Our Strategic Plan</a></li>
            ...
            <div>
              ...
              <a 
                href="/newsletter" 
                className="inline-block w-full py-2 bg-green-500 text-white font-semibold rounded-lg hover:bg-green-600 transition duration-300 text-center"
              >
                Sign up
              </a>
              
              <h4 className="text-lg font-semibold mt-6 mb-4 text-green-500">Follow us</h4>
