...
const pageMetadata = createPageMetadata({
  ...
  description: 'Join 4,500+ labs worldwide in reducing environmental impact through My Green Lab Certification. Get expert guidance, free tools, and join the global sustainable science movement.',
  keywords: 'laboratory sustainability, green lab certification, sustainable science, environmental impact reduction, lab energy efficiency, waste reduction, green chemistry',
  canonical: 'https://mygreenlab.org/',
  openGraph: {
    type: 'website',
    url: 'https://mygreenlab.org/',
    image: 'https://mygreenlab.org/wp-content/uploads/2025/07/AdobeStock_scientist-view-microscope-scaled.jpeg',
  },
  twitter: {
    image: 'https://mygreenlab.org/wp-content/uploads/2025/07/AdobeStock_scientist-view-microscope-scaled.jpeg',
  },
          ...
          <section id="green-lab" className="relative overflow-hidden">
            <div className="lg:grid lg:grid-cols-2 min-h-[90vh]">
              ...
              <div className="flex flex-col justify-center px-6 sm:px-10 lg:px-16 py-16 sm:py-20 gap-6 order-2 lg:order-1">
                <h1 className="mgl-serif text-[1.8rem] sm:text-[2.4rem] lg:text-[3.3rem] leading-tight font-semibold text-mgl-dark">
          ...
          <section className="bg-mgl-light-bg py-16 lg:py-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="p-6 sm:p-8 rounded-xl bg-mgl-stats-green text-white shadow-lg">
                  <p className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-2">4,500+ Labs</p>
                  <p className="text-xs sm:text-sm opacity-90">using My Green Lab® Certifications worldwide.</p>
                </div>
                <div className="p-6 sm:p-8 rounded-xl bg-mgl-stats-green text-white shadow-lg">
                  <p className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-2">50,000+ Scientists</p>
                  <p className="text-xs sm:text-sm opacity-90">in our community using our free tools and resources.</p>
                </div>
                <div className="p-6 sm:p-8 rounded-xl bg-mgl-stats-green text-white shadow-lg">
                  <p className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-2">50+ Countries</p>
                  <p className="text-xs sm:text-sm opacity-90">with a global community of advocates and partners.</p>
                </div>
                <div className="p-6 sm:p-8 rounded-xl bg-mgl-stats-green text-white shadow-lg">
                  <p className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-2">2,000+ ACT® Products</p>
                  <p className="text-xs sm:text-sm opacity-90">helping labs make responsible purchasing decisions.</p>
                </div>
                <div className="p-6 sm:p-8 rounded-xl bg-mgl-stats-green text-white shadow-lg">
                  <p className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-2">8,500+ Ambassadors</p>
                  <p className="text-xs sm:text-sm opacity-90">implementing green lab practices within their organizations and research communities.</p>
                </div>
                <div className="p-6 sm:p-8 rounded-xl bg-mgl-stats-green text-white shadow-lg">
                  <p className="text-2xl sm:text-3xl md:text-4xl font-extrabold mb-2">3,700+ Participants</p>
                  <p className="text-xs sm:text-sm opacity-90">in our Freezer Challenge to optimize cold storage management to reduce energy consumption.</p>
                </div>
              </div>
            </div>
          </section>
