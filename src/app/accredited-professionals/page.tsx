...
const App: React.FC = () => {
    ...
    return (
        <div className="min-h-screen font-sans text-gray-900 bg-white">
            ...
            <section ref={whySectionRef} className="py-20 bg-white" id="why">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center mb-16">
                        ...
                        <a href="#modules" className="flex items-center text-base font-semibold text-mgl-lime group">
                            Explore Modules
                        ...
                        <div className="flex flex-col h-full animate-on-scroll opacity-0 translate-y-5 transition-all duration-600" data-animation-delay="0">
                                <div className="flex-shrink-0">
                                    <img
                                        ...
                                        width="1290"
                                        height="925"
                                        className="w-full aspect-[1290/925] object-cover rounded-xl shadow-lg mb-6"
                                    />
                                </div>
                            <div className="flex-grow flex flex-col justify-between text-center">
                                <div>
                                    ...
                                    <p className="text-base font-semibold text-mgl-lime mb-4">In-depth knowledge from industry leaders</p>
                                    <p className="text-sm text-gray-700">Access in-depth education on green lab topics and solutions from leading experts in laboratory sustainability and environmental practices.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col h-full animate-on-scroll opacity-0 translate-y-5 transition-all duration-600" data-animation-delay="200">
                            ...
                            <div className="flex-grow flex flex-col justify-between text-center">
                                <div>
                                    ...
                                    <p className="text-base font-semibold text-mgl-lime mb-4">Engaging learning experience</p>
                                    <p className="text-sm text-gray-700">Immerse yourself in interactive content including infographics, videos, quizzes & worksheets designed to reinforce concepts and build practical skills.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section ref={coverSectionRef} className="py-20 bg-mgl-seafoam">
            ...
            <section ref={pricingSectionRef} className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {/* Commercial Pricing */}
                        <div className="p-8 border-4 border-gray-100 rounded-2xl shadow-lg bg-mgl-light-bg animate-on-scroll opacity-0 translate-y-5 transition-all duration-600 hover:shadow-xl hover:-translate-y-1.25 transition-all duration-300" data-animation-delay="100">
                            <h4 className="text-xl font-bold text-gray-900 mb-2">COMMERCIAL PRICING</h4>
                            <p className="text-3xl font-extrabold text-mgl-lime mb-4">
                            ...
                            <button className="w-full py-3 bg-white text-mgl-lime border border-mgl-lime font-semibold rounded-full hover:bg-mgl-cream transition-colors duration-300">
                                Access discounted pricing
                            </button>
                        </div>

                        {/* Academic & Non-Profit Pricing */}
                        <div className="p-8 border-4 border-gray-100 rounded-2xl shadow-lg bg-mgl-light-bg animate-on-scroll opacity-0 translate-y-5 transition-all duration-600 hover:shadow-xl hover:-translate-y-1.25 transition-all duration-300" data-animation-delay="300">
                            ...
                            <div key={index} className="flex flex-col h-full animate-on-scroll opacity-0 translate-y-5 transition-all duration-600" data-animation-delay={module.delay}>
                                <div className="flex-shrink-0">
                                    <img
                                        ...
                                        className="w-full xl:max-w-[850px] xl:h-[567px] object-cover rounded-xl shadow-lg mb-4"
                                    />
                                </div>
                                <div className="flex-grow">
                                    <h4 className="text-xl font-bold text-gray-900 mb-2">{module.title}</h4>
                                    <p className="text-sm text-gray-700 mb-4 line-clamp-4">{module.text}</p>
                                </div>
                                <div className="flex-shrink-0">
                                    <a href="#" className="text-mgl-lime font-semibold text-sm hover:underline">Access {module.title} Module</a>
                                </div>
                            </div>
                        ))}
                    </div>
            ...
            <section className="relative py-20 bg-white overflow-hidden">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-center animate-on-scroll opacity-0 translate-y-5 transition-all duration-600" data-animation-delay="0">
                        {/* Image/Quote Holder */}
            ...
            <section ref={developerSectionRef} className="py-20 bg-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-base text-gray-600 max-w-4xl mx-auto mb-16 animate-on-scroll opacity-0 translate-y-5 transition-all duration-600" data-animation-delay="0">
                    ...
                    {/* Developers Grid */}
                    <div className="grid grid-cols-3 gap-x-6 gap-y-10" id="developer-grid">
                        {[
