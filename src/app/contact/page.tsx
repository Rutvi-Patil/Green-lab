  ...
  return (
    <div className="bg-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-12">
          <a href="/" className="text-sm font-medium text-gray-500 hover:text-green-800 transition duration-150 mb-8 inline-flex items-center">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="lg:w-1/2 flex justify-center lg:justify-end">
              ...
              <div className="w-72 h-72 sm:w-96 sm:h-96 rounded-full overflow-hidden shadow-2xl transform hover:scale-[1.02] transition duration-500 ease-in-out">
                <img src="https://mygreenlab.org/wp-content/uploads/2025/07/297681440688830751-scaled-920x1380.jpg" 
