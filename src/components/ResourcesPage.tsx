...
const pageMetadata = createPageMetadata({
  title: 'Laboratory Sustainability Resources | Green Lab Guides & Best Practices',
  description: 'Access comprehensive laboratory sustainability resources, guides, and best practices. Learn waste reduction, energy efficiency, green chemistry, and sustainable lab operations.',
  keywords: 'laboratory sustainability resources, green lab guides, sustainable lab practices, waste reduction labs, energy efficiency laboratory, green chemistry resources, lab sustainability best practices',
  canonical: 'https://mygreenlab.org/resources',
  openGraph: {
    type: 'website',
    url: 'https://mygreenlab.org/resources',
    image: 'https://mygreenlab.org/wp-content/uploads/2025/07/AdobeStock_scientist-analyzing-samples-in-lab-hero-scaled-650x433.jpeg',
  },
  twitter: {
    image: 'https://mygreenlab.org/wp-content/uploads/2025/07/AdobeStock_scientist-analyzing-samples-in-lab-hero-scaled-650x433.jpeg',
  },
  jsonLd: [
    createBreadcrumbSchema([
      ...
      { name: 'Resources', url: 'https://mygreenlab.org/resources' }
    ]),
    createFAQSchema([
      {
        question: 'What sustainability topics are covered in your resources?',
        answer: 'Our resources cover comprehensive lab sustainability topics including waste reduction, water conservation, energy efficiency, green chemistry, sustainable procurement, and building a culture of sustainability.'
      },
      {
        question: 'Are your resources free to access?',
        answer: 'Yes! Most of our sustainability resources are freely available to help laboratories worldwide implement environmentally responsible practices.'
      },
      {
        question: 'Do you provide resources for different types of laboratories?',
        answer: 'Absolutely! Our resources are designed for various laboratory types including research labs, academic institutions, commercial labs, and healthcare facilities.'
      },
      {
        question: 'How often are your resources updated?',
        answer: 'We regularly update our resources with the latest research, best practices, and industry standards to ensure you have access to current sustainability information.'
      }
    ])
  ]
});
...
const useScrollAnimation = (rootRef: React.RefObject<HTMLElement | null>) => {
    useEffect(() => {
        ...
        // Observe root container, and let observer find the children
        ...
        <>
            ...
            <section ref={practicalStepsRef} className="py-20 bg-white" id="practical-steps">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row justify-between items-center mb-16">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 max-w-2xl mb-4 md:mb-0">
            ...
            <section ref={moreResourcesRef} className="py-20 bg-gray-50" id="more-resources">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <p className="text-base text-gray-600 mb-12 max-w-5xl mx-auto text-center animate-on-scroll opacity-0 translate-y-5 transition-all duration-600" data-animation-delay="0">
                        Stay informed with latest insights, expert advice, and practical guidance for laboratory sustainability.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-lg animate-on-scroll opacity-0 translate-y-5 transition-all duration-600 hover:shadow-xl hover:-translate-y-1.25 transition-all duration-300" data-animation-delay="200">
                            ...
                            <h5 className="text-base font-semibold text-mgl-lime mb-3">Tips for managing energy consumption in lab</h5>
                            <p className="text-sm text-gray-700 mb-4">
                                There are many ways laboratories can improve their operations, increase inventory management reliability, reduce costs, and enhance reproducibility of experiments.
                            </p>
                            <a href="#" className="text-mgl-lime font-semibold text-sm hover:underline">
                                Learn More
                                <ArrowRight className="w-4 h-4 ml-1 inline" />
