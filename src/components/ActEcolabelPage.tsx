            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                  Access ACT Ecolabel database
                </h2>
                <p className="text-lg text-gray-600 mb-6">
                  Search thousands of certified lab products across 50+ manufacturers, and compare third-party verified sustainability scores at product level.
                </p>
                <a 
...
<section className="py-20 bg-white">
  ...
  <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    {/* 1. Use aspect-video (16:9) for standard large feel, or keep 21/9 for ultrawide.
      2. Added 'relative' and used 'absolute' inset-0 on iframe to ensure it fills box.
    */}
    <div className="relative aspect-video rounded-2xl overflow-hidden shadow-2xl bg-black">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              What's in ACT Ecolabel?
            </h2>
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              The ACT Ecolabel uses a science-based, 100-point weighted score, with details on product impacts such as energy use, materials, chemical hazards, and end-of-life options—plus an evaluation of manufacturing facility and company commitments to reduce greenhouse gas emissions.
            </p>
          </div>
          <div className="flex justify-center">
            <img 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-4xl mx-auto mb-8">
              The ACT Ecolabel is only ecolabel for lab products recommended by U.S. EPA and aligned with EU regulations, supporting sustainable procurement across global markets.
            </p>
            <a 
              href="#" 
              className="inline-block py-3 px-8 text-lg font-semibold rounded-full border-2 border-green-500 text-green-500 hover:bg-green-500 hover:text-white transition duration-300"
          ...
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center p-8 bg-gray-50 rounded-xl">
              ...
              <div>
                <p className="text-lg text-gray-600 mb-6">
                  Use ACT Ecolabel to demonstrate verified environmental performance, eliminate custom questionnaires, and align with customers' procurement expectations.
                </p>
                <p className="text-base font-semibold text-green-600">
                  For Manufacturers
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center">
            <img 
              ...
              alt="How ACT Ecolabel program works" 
      ...
      <section className="py-16 bg-white" id="act-2-0-features">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              What sets ACT Ecolabel 2.0 apart
            </h2>
            <p className="text-lg text-gray-600 max-w-4xl mx-auto mb-8">
              Explore core features that make ACT Ecolabel 2.0 a powerful tool for evaluating, comparing, and communicating lab product sustainability.
            </p>
            <a 
              href="#" 
              className="inline-block py-3 px-8 text-lg font-semibold rounded-full border-2 border-green-500 text-green-500 hover:bg-green-500 hover:text-white transition duration-300"
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center p-8 bg-gray-50 rounded-xl">
              ...
              <div>
                <p className="text-lg text-gray-600">
                  The updated 100-point science-based scoring system ensures that categories with most impact on environment receive appropriate focus and relevance to procurement decision makers.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center p-8 bg-gray-50 rounded-xl">
              ...
              <div>
                <p className="text-lg text-gray-600">
                  ACT 2.0 is global standard, providing a single label valid in all markets worldwide to support international sales strategies and procurement alignment.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center p-8 bg-gray-50 rounded-xl">
              ...
              <div>
                <p className="text-lg text-gray-600">
                  The ACT Ecolabel is approved by U.S. EPA and aligned with EU and other global regulations on environmental claims, ensuring clear communication and reducing regulatory risk.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="mb-6">
                <p className="text-lg font-semibold text-gray-900 mb-2">Build marketing trust with ACT Ecolabel</p>
                <p className="text-gray-600">
                  Join 50+ manufacturers using ACT Ecolabel to win RFQs, eliminate custom questionnaires, and demonstrate environmental leadership.
                </p>
              </div>
              <a 
                href="#" 
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600">
                  Use ACT Ecolabel to compare thousands of certified products with standardized, third-party verified data that supports ESG goals and Scope 3 reporting.
                </p>
              </div>
              <a 
                href="https://actdatabase.mygreenlab.org/" 
      ...
      <section className="py-16 bg-green-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm tracking-widest uppercase font-semibold text-green-100 mb-2">Ready to Join Movement?</p>
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
            Get your product ACT Ecolabel certified
          </h2>
          <p className="text-lg text-green-100 mb-8 max-w-3xl mx-auto">
            Join leading manufacturers using ACT Ecolabel to win RFQs, rise above greenwashing, and demonstrate credible environmental leadership.
          </p>
          <a 
            href="#" 
